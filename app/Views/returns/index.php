...
<div class="card">
  <div class="card-body">
    ...
    <div class="overflow-x-scroll">
       <div>
        <a href="<?= site_url('admin/returns?sort=latest') ?>" <?= $sort === 'latest' ? 'style="font-weight: bold;"' : '' ?>>Latest</a> |
        <a href="<?= site_url('admin/returns?sort=oldest') ?>" <?= $sort === 'oldest' ? 'style="font-weight: bold;"' : '' ?>>Oldest</a>
      </div>
          ...
          ?>
            <tr>
              ...
              <td>
                ...
                <a href="<?= site_url('admin/returns/print/' . esc($loan['uid'])); ?>" class="btn btn-secondary mb-2"><i class="ti ti-printer"></i>Print</a>
