      ...
      <div class="row">
        ...
        <div class="col-12 col-md-6 col-lg-8 col-xl-9">
          ...
          <div class="mb-3">
            ...
            <input type="text" class="form-control <?php if ($validation->hasError('panggil')) : ?>is-invalid<?php endif ?>" id="panggil" name="panggil" value="<?= $oldInput['panggil'] ?? $book['panggil']; ?>" required>
            <div class="invalid-feedback">
