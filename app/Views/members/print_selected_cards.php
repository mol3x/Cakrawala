...
<head>
    ...
    <style>
       ...
       .button-container {
            position: fixed; /* Mengatur posisi menjadi absolut */
            top: 20px; /* Jarak dari bagian atas halaman */
            left: 50%; /* Menempatkan di tengah secara horizontal */
            transform: translateX(-50%); /* Menggeser tombol ke kiri setengah lebar tombol untuk benar-benar berada di tengah */
            text-align: center; /* Pastikan teks tombol berada di tengah */
            z-index: 101;
        }
...
<body>
    <a class="posisi" href="javascript:history.back()" class="btn btn-outline-primary">
            <div class="back">
