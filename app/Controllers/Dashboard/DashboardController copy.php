...
class DashboardController extends ResourceController
{
    ...
    {
        // Mengambil data pengaturan dengan memanggil render dari BaseController
        $baseController = new BaseController();
        $baseController->initController($this->request, $this->response, \Config\Services::logger());

        // Menambahkan data pengaturan dari BaseController
        $data = array_merge(
            $baseController->data,  // Data dari BaseController (setting)
